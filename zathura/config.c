...
#define PRESENTATION zathura->modes.presentation
  ...
  /* commands */
  girara_inputbar_command_add(gsession, "exec",  NULL, girara_cmd_exec,        NULL,          _("Execute a command"));
  ...
  /* config handle */
  girara_config_handle_add(gsession, "map",   girara_cmd_map);
  girara_config_handle_add(gsession, "set",   girara_cmd_set);
  girara_config_handle_add(gsession, "unmap", girara_cmd_unmap);

  /* shortcut mappings */
  girara_shortcut_mapping_add(gsession, "exec",             girara_sc_exec);
  ...
  girara_shortcut_mapping_add(gsession, "quit",             girara_sc_quit);
